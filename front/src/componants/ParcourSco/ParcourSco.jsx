...
import './parcourSco.css';

function ParcourSco() {
  const [parcourSco, setParcourScos] = useState(null);

  useEffect(() => {
    axios.get('http://localhost:3001/schoolCarreer')
      .then(response => {
        setParcourScos(response.data);
  ...
  return (
    ...
    <section id="parcourSco" className="py-5 ">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="our_solution_category">
              <div class="solution_cards_box">
                {parcourSco && parcourSco.map((item, index) => (
                  <div class="solution_card" key={index}>
